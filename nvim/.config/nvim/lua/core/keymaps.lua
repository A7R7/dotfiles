...
if Util.has("smart-splits.nvim") then
  ...
  local split = require("smart-splits")
	map("n", "<C-h>", function() split.move_cursor_left() end,  { desc = "Go to left window" })
	map("n", "<C-j>", function() split.move_cursor_down() end,  { desc = "Go to lower window" })
	map("n", "<C-k>", function() split.move_cursor_up() end,    { desc = "Go to upper window" })
	map("n", "<C-l>", function() split.move_cursor_right() end, { desc = "Go to right window" })
	map("t", "<C-h>", function() split.move_cursor_left() end,  { desc = "Go to left window" })
	map("t", "<C-j>", function() split.move_cursor_down() end,  { desc = "Go to lower window" })
	map("t", "<C-k>", function() split.move_cursor_up() end,    { desc = "Go to upper window" })
	map("t", "<C-l>", function() split.move_cursor_right() end, { desc = "Go to right window" })
	-- Resize window using <ctrl> arrow keys
	map("n", "<C-Up>",    function() split.resize_up() end,    { desc = "Resize window up" })
	map("n", "<C-Down>",  function() split.resize_down() end,  { desc = "Resize window down" })
	map("n", "<C-Left>",  function() split.resize_left() end,  { desc = "Resize window left" })
	map("n", "<C-Right>", function() split.resize_right() end, { desc = "Resize window right" })
	map("t", "<C-Up>",    function() split.resize_up() end,    { desc = "Resize window up" })
	map("t", "<C-Down>",  function() split.resize_down() end,  { desc = "Resize window down" })
	map("t", "<C-Left>",  function() split.resize_left() end,  { desc = "Resize window left" })
	map("t", "<C-Right>", function() split.resize_right() end, { desc = "Resize window right" })
else
	-- Move to window using the <ctrl> hjkl keys
